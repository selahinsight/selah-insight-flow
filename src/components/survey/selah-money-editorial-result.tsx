...
const faithDefinitions: Record<string, string> = {
  "편안한 신앙 연결형": "기도와 말씀을\n일상의 돈 관리에 자연스럽게\n연결하는 편이에요.",
  "신앙부담형": "하나님 앞에서 바른 선택을 하고 싶은 마음이 커서, 돈을 쓸 때 부담을 느끼는 유형이에요.",
  "신앙분리형": "돈 결정을 기도와 말씀에 연결하기보다, 현실적인 기준으로 판단하는 유형이에요.",
  "신앙·돈 기준 혼란형": "돈을 쓸 때 말씀을 어떻게 적용할지 몰라, 마음이 자주 흔들리는 유형이에요.",
};

const moneyDefinitions: Record<string, string> = {
  "확인긴장형": "미래를 충분히 준비하지 못했을까 걱정해 돈을 확인할 때 마음이 무거워지는 유형이에요.",
  "평가부담형": "다른 사람처럼 갖추고 싶은 마음에 돈을 쓰고, 카드값을 확인하기가 부담스러운 유형이에요.",
  "회피위로형": "돈을 확인하는 일은 미루고, 답답한 마음은 소비로 달래는 유형이에요.",
  "기준압박형": "미래가 걱정되지만, 남들보다 부족해 보이고 싶지 않은 유형이에요.",
  "긴장보상형": "미래가 걱정돼 평소에는 지출을 줄이지만, 답답함이 쌓이면 한꺼번에 돈을 쓰는 유형이에요.",
  "비교위로형": "다른 사람과 비교해\n내 모습이 부족하게 느껴지면,\n속상한 마음을 달래려고\n계획에 없던 돈까지 쓰는 편이에요.",
  "불안보상형": "미래의 돈은 걱정되고,\n현재 돈을 확인하기는 두려워\n쌓인 불안을 소비로 달래는 편이에요.",
  "인정회피형": "남들처럼 갖추고 싶어 돈을 쓰지만, 쓴 금액을 확인하기는 부담스러운 유형이에요.",
  "평가불안형": "다른 사람과 비교하며\n계획보다 돈을 쓴 후,\n미래 준비가 불안해져\n확인과 정리를 미루는 편이에요.",
  "확인기준압박형": "다른 사람과 비교해 돈을 쓴 뒤, 미래가 걱정되지만 현재 돈의 상태를 확인하기는 부담스러운 유형이에요.",
  "부족보상형": "미래를 위해 돈을 아끼는 동안 나만 누리지 못하는 것 같아, 어느 순간 크게 쓰고 싶어지는 유형이에요.",
  "전반적 복합반응형": "돈에 대한 걱정과 불편한 감정이 뒤섞여\n무엇부터 관리해야 할지\n막막한 편이에요.",
  "돈 기준 탐색형": "돈을 모으고 쓰는 기준이 분명하지 않아\n돈 관리의 방향을 잡기\n어려운 편이에요.",
