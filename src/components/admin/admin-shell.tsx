...
import { ArrowLeft, BarChart3, ClipboardCheck, Home, LayoutDashboard, ListChecks, Mail, MessageSquare, Settings2, Users } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/money-results-review", label: "머니 결과 전체 검수", icon: ClipboardCheck },
];
